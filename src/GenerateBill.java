...
public class GenerateBill extends JFrame implements ActionListener{
    JLabel generateBillLabel, meterLabel;
    JTextArea t1;
    JButton generateBillBtn;
    Choice c2;
    JPanel generateBillPanel;
    String meter;
    GenerateBill(String meter){
        ...
        generateBillPanel.add(generateBillLabel);
        generateBillPanel.add(meterLabel);
        generateBillPanel.add(c2);
        add(generateBillPanel,"North");
        
        add(jsp,"Center");
        add(generateBillBtn,"South");
